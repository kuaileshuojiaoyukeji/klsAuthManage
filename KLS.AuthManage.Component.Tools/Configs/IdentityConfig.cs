...
namespace KLS.AuthManage.Component.Tools.Configs
{
    ...
    public class ApplicationUserManager : UserManager<User, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<hzwxdb>()));
    ...
    public class MD5PasswordHasher : IPasswordHasher
    {
        ...
        {
            if (hashedPassword.Equals(GetMd5Hash(providedPassword)))
